...
def test_multikd(s_net, t_net1, params):
    ...
    t_net2 = util.load_checkpoint(
        t_net2, "/home/khincho/distillers/distiller/results/TEACHERS/FER+/WRN28_1_SPHERED_FL2_SGD_MULTISTEPLR/ferplus/WRN28_1_teacher_best.pth.tar")
    ...
    t_net3 = util.load_checkpoint(
        t_net3, "/home/khincho/distillers/distiller/results/TEACHERS/FER+/WRN40_1_SPHERED_FL2_SGD_MULTISTEPLR/ferplus/WRN40_1_teacher_best.pth.tar")
    t_net3 = freeze_teacher(t_net3)

    t_nets = [t_net2, t_net3]
    print(f"Using Student --> {kd_config['test_name']}")
