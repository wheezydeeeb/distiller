...
def test_multikd(s_net, t_net1, params):
    ...
    t_net2 = util.load_checkpoint(
        t_net2, "/home/khincho/distillers/distiller/results/TEACHERS/FER+/WRN28_1_SPHERED_FL2_FSAMS_CANNLR/ferplus/nokd/WRN28_1_best.pth.tar")
    ...
    t_net3 = util.load_checkpoint(
        t_net3, "/home/khincho/distillers/distiller/results/TEACHERS/FER+/WRN40_1_SPHERED_FL2_FSAMS_CANNLR/ferplus/nokd/WRN40_1_best.pth.tar")
